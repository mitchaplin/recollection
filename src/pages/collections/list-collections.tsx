...
const Collections: NextPage = () => {
  ...
  return (
    <main className="flex h-screen w-screen justify-center overflow-y-auto p-8">
      <div>
        <div className="flex flex-col items-center  justify-center gap-4 p-8 xl:flex-row xl:justify-between">
          <form className="w-72">
            <label
            ...
            return (
              ...
              >
                ...
                <div className="flex flex-grow flex-col p-8">
                  ...
                  <button className="mt-6 inline-flex items-center rounded-lg bg-brand-actionBlue px-3 py-2 text-center text-sm font-medium text-brand-offWhite hover:bg-brand-subtleBlue  focus:outline-brand-lightBlue ">
                    <Link
