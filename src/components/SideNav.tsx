...
export const SideNav: NextPage = () => {
  ...
  return (
    <span ref={ref} className="h-screen">
      <button
        ...
        type="button"
        className="absolute z-50 ml-3 mt-2 inline-flex items-center rounded-lg p-2 text-sm text-gray-500 hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-gray-200 dark:text-gray-400 dark:hover:bg-gray-700 dark:focus:ring-gray-600 md:hidden"
      >
      ...
      <aside
        ...
        } z-40 h-screen min-w-[16rem] border-r border-gray-700 md:relative md:block`}
        aria-label="Sidebar"
      >
